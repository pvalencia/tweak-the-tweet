...
class TweetDispatcher(object):
	...
	def insert_match(self, host, user, passwd, db, request_id, response_id):
		self.db =  MySQLdb.connect(host, user, passwd, db)
		sql = "INSERT INTO tweet_matches(request_id, response_id) VALUES(%i, %i);" % (request_id, response_id)
		self.db.query(sql)
